    ...
    <div>
      ...
      <div className="grid gap-4 lg:grid-cols-[1.35fr_0.85fr]">
        ...
        <Card className="order-1 h-fit sticky top-[4.25rem] z-10 lg:order-2 lg:top-20">
          ...
          <p className="mt-4 rounded-xl bg-app px-3 py-2 text-xs text-muted">
            GST is applied once on the guest&apos;s total food bill when you clear it from{" "}
            <span className="font-semibold text-app">Invoices → Food</span>.
          </p>
